 ...
 *
 * Une disposition en colonne pour le portrait a été écrite puis retirée : elle
 * tenait dans l'écran mais ne servait pas le jeu. Sur un téléphone debout, on
 * demande donc de tourner l'appareil.
 */
